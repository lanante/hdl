...
set_property -dict {PACKAGE_PIN D18    IOSTANDARD LVDS_25} [get_ports clkin]                            ; ## G02  FMC_LPC_CLK1_M2C_P
...
set_property -dict {PACKAGE_PIN N22    IOSTANDARD LVDS_25} [get_ports pll_sync_fmc]                     ; ## G09  FMC_LPC_LA03_P 
set_property -dict {PACKAGE_PIN P22    IOSTANDARD LVDS_25} [get_ports cnv_en]                           ; ## G10  FMC_LPC_LA03_N

# clocks

create_clock -name adc_clk -period 66.666   [get_ports dco_p]
create_clock -name ref_clk -period 8.33     [get_ports clkin]
